...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/data/data/com.termux/files/home/ytgui-env/bin',
    'BINLIBDEST': '/data/data/com.termux/files/home/ytgui-env/lib/python3.13',
    'BLDLIBRARY': 'libpython3.13.a',
    'BLDSHARED': 'gcc -shared -Wl,--as-needed -Wl,-O1',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CC': 'gcc',
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition',
    'CFLAGSFORSHARED': '',
    ...
    'CONFIGURE_CFLAGS': '-O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-Wl,--as-needed -Wl,-O1',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/data/data/com.termux/files/home/ytgui-env' 'CFLAGS=-O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition' 'LDFLAGS=-Wl,--as-needed -Wl,-O1'",
    'CONFINCLUDEDIR': '/data/data/com.termux/files/home/ytgui-env/include',
    'CONFINCLUDEPY': '/data/data/com.termux/files/home/ytgui-env/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/data/data/com.termux/files/home/Python-3.13.5/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/data/data/com.termux/files/home/Python-3.13.5/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++',
    'DESTDIRS': '/data/data/com.termux/files/home/ytgui-env /data/data/com.termux/files/home/ytgui-env/lib /data/data/com.termux/files/home/ytgui-env/lib/python3.13 /data/data/com.termux/files/home/ytgui-env/lib/python3.13/lib-dynload',
    'DESTLIB': '/data/data/com.termux/files/home/ytgui-env/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/data/data/com.termux/files/home/ytgui-env/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/data/data/com.termux/files/home/ytgui-env/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/data/data/com.termux/files/home/ytgui-env/include /data/data/com.termux/files/home/ytgui-env/include /data/data/com.termux/files/home/ytgui-env/include/python3.13 /data/data/com.termux/files/home/ytgui-env/include/python3.13',
    'INCLUDEDIR': '/data/data/com.termux/files/home/ytgui-env/include',
    'INCLUDEPY': '/data/data/com.termux/files/home/ytgui-env/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -shared -Wl,--as-needed -Wl,-O1',
    'LDFLAGS': '-Wl,--as-needed -Wl,-O1',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -shared -Wl,--as-needed -Wl,-O1',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/data/data/com.termux/files/home/ytgui-env/lib/python3.13',
    'LIBDIR': '/data/data/com.termux/files/home/ytgui-env/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/data/data/com.termux/files/home/ytgui-env/lib/pkgconfig',
    'LIBPL': '/data/data/com.termux/files/home/ytgui-env/lib/python3.13/config-3.13-aarch64-linux-android',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/data/data/com.termux/files/home/ytgui-env/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/data/data/com.termux/files/home/ytgui-env/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': '/data/data/com.termux/files/usr/bin/mkdir -p',
    'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  _json  _lsprof  _opcode  _pickle  _queue  _random  _struct  _interpreters  _interpchannels  _interpqueues  _zoneinfo  math  cmath  _statistics  _datetime  _decimal  binascii  _bz2  _lzma  zlib  _dbm  _gdbm  readline  _md5  _sha1  _sha2  _sha3  _blake2  pyexpat  _elementtree  _codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  unicodedata  fcntl  mmap  _posixsubprocess  resource  select  _socket  syslog  termios  _multiprocessing  _ctypes  _curses  _curses_panel  _sqlite3  _ssl  _hashlib  _uuid  xxsubtype  _xxtestfuzz  _testbuffer  _testinternalcapi  _testcapi  _testlimitedcapi  _testclinic  _testclinic_limited  _testimportmultiple  _testmultiphase  _testsinglephase  _testexternalinspection  _ctypes_test  xxlimited  xxlimited_35  atexit  faulthandler  posix  _signal  _tracemalloc  _suggestions  _codecs  _collections  errno  _io  itertools  _sre  _sysconfig  _thread  time  _typing  _weakref  _abc  _functools  _locale  _operator  _stat  _symtable  pwd',
    'MODDISABLED_NAMES': '',
    'MODLIBS': '',
    ...
    'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 -I/data/data/com.termux/files/usr/include',
    ...
    'MODULE_READLINE_CFLAGS': '-DNCURSES_WIDECHAR -I/data/data/com.termux/files/usr/include',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/data/data/com.termux/files/usr/include',
    ...
    'MODULE__CURSES_CFLAGS': '-DNCURSES_WIDECHAR -I/data/data/com.termux/files/usr/include',
    'MODULE__CURSES_DEPS': './Include/py_curses.h',
    'MODULE__CURSES_LDFLAGS': '-L/data/data/com.termux/files/usr/lib -Wl,-rpath=/data/data/com.termux/files/usr/lib -Wl,--enable-new-dtags -lncursesw',
    'MODULE__CURSES_PANEL_CFLAGS': '-DNCURSES_WIDECHAR -I/data/data/com.termux/files/usr/include -DNCURSES_WIDECHAR -I/data/data/com.termux/files/usr/include',
    'MODULE__CURSES_PANEL_DEPS': './Include/py_curses.h',
    'MODULE__CURSES_PANEL_LDFLAGS': '-L/data/data/com.termux/files/usr/lib -Wl,-rpath=/data/data/com.termux/files/usr/lib -Wl,--enable-new-dtags -lpanelw -L/data/data/com.termux/files/usr/lib -Wl,-rpath=/data/data/com.termux/files/usr/lib -Wl,--enable-new-dtags -lncursesw',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/data/data/com.termux/files/usr/include -I./Modules/_sqlite',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-Wl,--as-needed -Wl,-O1',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-Wl,--as-needed -Wl,-O1',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-Wl,--as-needed -Wl,-O1',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -march=armv8-a -mtune=cortex-a75 -funroll-loops -fomit-frame-pointer -fno-semantic-interposition -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'PY_SUPPORT_TIER': 2,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_GIL_DISABLED': 0,
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/data/data/com.termux/files/home/ytgui-env/lib',
    'SCRIPT_IDLE': 'build/scripts-3.13/idle3.13',
    'SCRIPT_PYDOC': 'build/scripts-3.13/pydoc3.13',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313-aarch64-linux-android.so Modules/_asyncio.cpython-313-aarch64-linux-android.so Modules/_bisect.cpython-313-aarch64-linux-android.so Modules/_contextvars.cpython-313-aarch64-linux-android.so Modules/_csv.cpython-313-aarch64-linux-android.so Modules/_heapq.cpython-313-aarch64-linux-android.so Modules/_json.cpython-313-aarch64-linux-android.so Modules/_lsprof.cpython-313-aarch64-linux-android.so Modules/_opcode.cpython-313-aarch64-linux-android.so Modules/_pickle.cpython-313-aarch64-linux-android.so Modules/_queue.cpython-313-aarch64-linux-android.so Modules/_random.cpython-313-aarch64-linux-android.so Modules/_struct.cpython-313-aarch64-linux-android.so Modules/_interpreters.cpython-313-aarch64-linux-android.so Modules/_interpchannels.cpython-313-aarch64-linux-android.so Modules/_interpqueues.cpython-313-aarch64-linux-android.so Modules/_zoneinfo.cpython-313-aarch64-linux-android.so Modules/math.cpython-313-aarch64-linux-android.so Modules/cmath.cpython-313-aarch64-linux-android.so Modules/_statistics.cpython-313-aarch64-linux-android.so Modules/_datetime.cpython-313-aarch64-linux-android.so Modules/_decimal.cpython-313-aarch64-linux-android.so Modules/binascii.cpython-313-aarch64-linux-android.so Modules/_bz2.cpython-313-aarch64-linux-android.so Modules/_lzma.cpython-313-aarch64-linux-android.so Modules/zlib.cpython-313-aarch64-linux-android.so Modules/_dbm.cpython-313-aarch64-linux-android.so Modules/_gdbm.cpython-313-aarch64-linux-android.so Modules/readline.cpython-313-aarch64-linux-android.so Modules/_md5.cpython-313-aarch64-linux-android.so Modules/_sha1.cpython-313-aarch64-linux-android.so Modules/_sha2.cpython-313-aarch64-linux-android.so Modules/_sha3.cpython-313-aarch64-linux-android.so Modules/_blake2.cpython-313-aarch64-linux-android.so Modules/pyexpat.cpython-313-aarch64-linux-android.so Modules/_elementtree.cpython-313-aarch64-linux-android.so Modules/_codecs_cn.cpython-313-aarch64-linux-android.so Modules/_codecs_hk.cpython-313-aarch64-linux-android.so Modules/_codecs_iso2022.cpython-313-aarch64-linux-android.so Modules/_codecs_jp.cpython-313-aarch64-linux-android.so Modules/_codecs_kr.cpython-313-aarch64-linux-android.so Modules/_codecs_tw.cpython-313-aarch64-linux-android.so Modules/_multibytecodec.cpython-313-aarch64-linux-android.so Modules/unicodedata.cpython-313-aarch64-linux-android.so Modules/fcntl.cpython-313-aarch64-linux-android.so Modules/mmap.cpython-313-aarch64-linux-android.so Modules/_posixsubprocess.cpython-313-aarch64-linux-android.so Modules/resource.cpython-313-aarch64-linux-android.so Modules/select.cpython-313-aarch64-linux-android.so Modules/_socket.cpython-313-aarch64-linux-android.so Modules/syslog.cpython-313-aarch64-linux-android.so Modules/termios.cpython-313-aarch64-linux-android.so Modules/_multiprocessing.cpython-313-aarch64-linux-android.so Modules/_ctypes.cpython-313-aarch64-linux-android.so Modules/_curses.cpython-313-aarch64-linux-android.so Modules/_curses_panel.cpython-313-aarch64-linux-android.so Modules/_sqlite3.cpython-313-aarch64-linux-android.so Modules/_ssl.cpython-313-aarch64-linux-android.so Modules/_hashlib.cpython-313-aarch64-linux-android.so Modules/_uuid.cpython-313-aarch64-linux-android.so Modules/xxsubtype.cpython-313-aarch64-linux-android.so Modules/_xxtestfuzz.cpython-313-aarch64-linux-android.so Modules/_testbuffer.cpython-313-aarch64-linux-android.so Modules/_testinternalcapi.cpython-313-aarch64-linux-android.so Modules/_testcapi.cpython-313-aarch64-linux-android.so Modules/_testlimitedcapi.cpython-313-aarch64-linux-android.so Modules/_testclinic.cpython-313-aarch64-linux-android.so Modules/_testclinic_limited.cpython-313-aarch64-linux-android.so Modules/_testimportmultiple.cpython-313-aarch64-linux-android.so Modules/_testmultiphase.cpython-313-aarch64-linux-android.so Modules/_testsinglephase.cpython-313-aarch64-linux-android.so Modules/_testexternalinspection.cpython-313-aarch64-linux-android.so Modules/_ctypes_test.cpython-313-aarch64-linux-android.so Modules/xxlimited.cpython-313-aarch64-linux-android.so Modules/xxlimited_35.cpython-313-aarch64-linux-android.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl  -llog',
    'SHLIB_SUFFIX': '.so',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './data/data/com.termux/files/home/ytgui-env',
    'WASM_STDLIB': './data/data/com.termux/files/home/ytgui-env/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/data/data/com.termux/files/home/Python-3.13.5',
    'abs_srcdir': '/data/data/com.termux/files/home/Python-3.13.5',
    'datarootdir': '/data/data/com.termux/files/home/ytgui-env/share',
    'exec_prefix': '/data/data/com.termux/files/home/ytgui-env',
    'prefix': '/data/data/com.termux/files/home/ytgui-env',
    'srcdir': '.',
}
