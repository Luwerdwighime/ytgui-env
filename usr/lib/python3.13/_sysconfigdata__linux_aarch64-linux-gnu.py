...
build_time_vars = {
    ...
    'BLDSHARED': 'aarch64-unknown-linux-gnu-gcc -shared',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CONFIGURE_CFLAGS': '',
    'CONFIGURE_CFLAGS_NODIST': '-O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden',
    ...
    'CONFIG_ARGS': "'--prefix=/usr' '--build=aarch64-unknown-linux-gnu' '--host=aarch64-unknown-linux-gnu' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--datadir=/usr/share' '--sysconfdir=/etc' '--localstatedir=/var/lib' '--datarootdir=/usr/share' '--docdir=/usr/share/doc/python-3.13.5' '--htmldir=/usr/share/doc/python-3.13.5/html' '--libdir=/usr/lib64' 'ac_cv_header_stropts_h=no' '--enable-shared' '--without-static-libpython' '--enable-ipv6' '--infodir=/usr/share/info' '--mandir=/usr/share/man' '--with-dbmliborder=gdbm' '--with-libc=' '--enable-loadable-sqlite-extensions' '--without-ensurepip' '--without-lto' '--with-system-expat' '--with-system-libmpdec' '--with-platlibdir=lib' '--with-pkg-config=yes' '--with-wheel-pkg-dir=/usr/lib/python/ensurepip' '--enable-gil' '--without-assertions' '--disable-experimental-jit' '--disable-optimizations' '--with-readline=readline' '--without-valgrind' 'build_alias=aarch64-unknown-linux-gnu' 'host_alias=aarch64-unknown-linux-gnu' 'PKG_CONFIG=aarch64-unknown-linux-gnu-pkg-config' 'CFLAGS=' 'LDFLAGS=' 'CPPFLAGS= -I/usr/include/ncursesw'",
    'CONFINCLUDEDIR': '/usr/include',
    'CONFINCLUDEPY': '/usr/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/var/tmp/portage/dev-lang/python-3.13.5/work/Python-3.13.5/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/var/tmp/portage/dev-lang/python-3.13.5/work/Python-3.13.5/lcov-report',
    ...
    'INSTALL_DATA': '/usr/lib/portage/python3.13/ebuild-helpers/xattr/install -c -m 644',
    'INSTALL_MIMALLOC': 'yes',
    'INSTALL_PROGRAM': '/usr/lib/portage/python3.13/ebuild-helpers/xattr/install -c',
    'INSTALL_SCRIPT': '/usr/lib/portage/python3.13/ebuild-helpers/xattr/install -c',
    'INSTALL_SHARED': '/usr/lib/portage/python3.13/ebuild-helpers/xattr/install -c -m 755',
    'INSTSONAME': 'libpython3.13.so.1.0',
    'IO_H': 'Modules/_io/_iomodule.h',
    'IO_OBJS': '\\',
    'IPHONEOS_DEPLOYMENT_TARGET': '',
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'aarch64-unknown-linux-gnu-g++ -shared',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    ...
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/usr/lib64/pkgconfig',
    'LIBPL': '/usr/lib/python3.13/config-3.13-aarch64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'LIBS': '-ldl',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': 'aarch64-unknown-linux-gnu-gcc',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG',
    'PY_CFLAGS_NODIST': '-O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -DPy_BUILD_CORE',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -mtune=native -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC',
    'PY_SUPPORT_TIER': 2,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.13.5/work/Python-3.13.5 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.13.5/work/Python-3.13.5 ./python -E -m test',
    ...
    'abs_builddir': '/var/tmp/portage/dev-lang/python-3.13.5/work/Python-3.13.5',
    'abs_srcdir': '/var/tmp/portage/dev-lang/python-3.13.5/work/Python-3.13.5',
